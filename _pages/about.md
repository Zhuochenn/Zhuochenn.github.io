...
I am a `Ph.D. candidate` in the [Robot Perception Lab(RPL)](https://kings-rpl.github.io/), supervised by Prof. [Shan Luo](https://shanluo.github.io/). I am also a research intern at Huawei [Noah's Ark Lab](https://dev3.noahlab.com.hk/research.html), London, supervised by Dr. [Jiankang Deng](https://jiankangdeng.github.io/). My passion lies in endowing robots with `tactile sensing` abilities akin to skin of humans. My Ph.D. research primarily focuses on overcoming challenges in vision-based tactile sensors and contact-rich robot grasping and manipulation tasks using learning-based methods, including generative learning, transfer learning, and reinforcement learning.
